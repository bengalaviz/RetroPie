...
#pragma parameter width "CocktailTable Image Width" 0.899 0.0 5.0 0.05
#pragma parameter separation "CocktailTable Image Separation" -0.399 -2.0 2.0 0.005
...
void main()
{
    ...
    _TMP0 = vec4(0.0);
    if ( fragCoord1.x < 0.999 && fragCoord1.x > 0.001 && fragCoord1.y < 1.1 && fragCoord1.y > 0.3555 )
    _TMP0 = COMPAT_TEXTURE(Texture, TEX0.xy + vec2( location_x, separation + location_y));

    _TMP1 = vec4(0.0);
    if ( fragCoord2.x < 0.999 && fragCoord2.x > 0.001 && fragCoord2.y < 1.1 && fragCoord2.y > 0.3555 )
